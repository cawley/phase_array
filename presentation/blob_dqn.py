...
from keras.callbacks import TensorBoard
from tensorflow import Variable, compat, Summary
...
class ModifiedTensorBoard(TensorBoard):
    ...
    def __init__(self, log_dir, **kwargs):
        ...
        )  # initialize the superclass with the log directory
        self._train_dir = os.path.join(self.log_dir, "train")  # define _train_dir

        self._train_step = Variable(0, dtype="int64", trainable=False)
        self._train_writer = Summary.create_file_writer(self._train_dir)
        self.step = 1
        self.writer = (
            SummaryWriter()
        )  # Use SummaryWriter from PyTorch's TensorBoard interface
    ...
    def _write_logs(self, stats, step):
        # Here, you should define how to write logs.
        # For example, if you're using TensorBoard, it might look something like this:
