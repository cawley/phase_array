...
def main():
  ...
  _, _, convInfoSARR = n_queens_SARR.steepestAscentRandomRestart(initialState, 100, 100)
  ...
  plt.plot(convInfoSARR[:, 0], convInfoSARR[:, 1])
  plt.plot(convInfoGAv2[:, 0], convInfoGAv2[:, 1])
  plt.show()
